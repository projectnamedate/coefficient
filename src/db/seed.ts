...
const pools = [
  ...
  { id: "phase", name: "Phase Delegation", lstTicker: "pdSOL", program: "spl-stake-pool", selfDealing: false },
  ...
  { id: "sharkpool", name: "SharkPool", lstTicker: "sharkSOL", program: "spl-stake-pool", selfDealing: false },
];
...
const scores = [
  ...
  { poolId: "doublezero", networkHealthScore: 62, smallValidatorBias: 50, selfDealing: 62, mevSandwichPolicy: 80, nakamotoImpact: 55, validatorSetSize: 93, geographicDiversity: 65, commissionDiscipline: 70, transparency: 60, activeSolStaked: 13357851, validatorCount: 318, medianApy: 5.62 },
  { poolId: "blazestake", networkHealthScore: 78, smallValidatorBias: 82, selfDealing: 78, mevSandwichPolicy: 85, nakamotoImpact: 75, validatorSetSize: 88, geographicDiversity: 72, commissionDiscipline: 75, transparency: 80, activeSolStaked: 1031679, validatorCount: 234, medianApy: 5.72 },
  ...
  { poolId: "vault", networkHealthScore: 35, smallValidatorBias: 45, selfDealing: 0, mevSandwichPolicy: 60, nakamotoImpact: 40, validatorSetSize: 65, geographicDiversity: 50, commissionDiscipline: 30, transparency: 25, activeSolStaked: 1249140, validatorCount: 121, medianApy: 5.82 },
  ...
  { poolId: "marinade", networkHealthScore: 52, smallValidatorBias: 50, selfDealing: 72, mevSandwichPolicy: 30, nakamotoImpact: 55, validatorSetSize: 45, geographicDiversity: 60, commissionDiscipline: 70, transparency: 65, activeSolStaked: 2888186, validatorCount: 57, medianApy: 5.86 },
  ...
  { poolId: "edgevana", networkHealthScore: 48, smallValidatorBias: 40, selfDealing: 42, mevSandwichPolicy: 70, nakamotoImpact: 45, validatorSetSize: 40, geographicDiversity: 35, commissionDiscipline: 72, transparency: 60, activeSolStaked: 828375, validatorCount: 48, medianApy: 5.75 },
  ...
  { poolId: "sharkpool", networkHealthScore: 60, smallValidatorBias: 65, selfDealing: 82, mevSandwichPolicy: 50, nakamotoImpact: 55, validatorSetSize: 15, geographicDiversity: 20, commissionDiscipline: 75, transparency: 40, activeSolStaked: 207928, validatorCount: 10, medianApy: 5.66 },
];
